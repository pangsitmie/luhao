...
import { currencyFormatter, numberFormatter } from 'src/utils/Utils';
            ...
            >
                    ...
                    {machineDatas.map((item, i) => {
                        ...
                        return (
                            <Box
                                ...
                                display={"flex"}
                                sx={{
                                    backgroundColor: isOverHighlighted ? colors.blueAccent[800] : (isBellowHighlighted ? colors.redAccent[800] : "transparent"),
                                    alignItems: "center",
                                    justifyContent: "center",
                                    padding: "0",
                                    margin: "0",
                            ...
                            >
                                ...
                                <Box sx={{ alignItems: "center", display: "flex" }}>
                                    <TableCell align="center"
                                        ...
                                        <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                            {currencyFormatter(item.node.coinDetail.combineAmount + item.node.coinDetail.immediateAmount + item.node.coinDetail.offlineAmount)}
                                        </Typography>
                                    </TableCell>
                                    <Collapse in={!isOfflineCoinCollapsed} hidden={isOfflineCoinCollapsed}>
                                        <TableCell align="center"
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.coinDetail.combineAmount)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell align="center"
                                            sx={{
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.coinDetail.combineQuantity)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell align="center"
                                            sx={{
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.coinDetail.immediateAmount)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell align="center"
                                            sx={{
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.coinDetail.immediateQuantity)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell align="center"
                                            sx={{
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.coinDetail.offlineAmount)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell align="center"
                                            sx={{
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.coinDetail.offlineQuantity)}
                                            </Typography>
                                        </TableCell>
                                    </Collapse>
                                </Box>
                                ...
                                <Box sx={{ alignItems: "center", display: "flex" }}>
                                    <TableCell
                                        ...
                                        <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                            {currencyFormatter(item.node.coinDetail.onlineCoinAmount + item.node.coinDetail.onlineFreeAmount)}
                                        </Typography>
                                    </TableCell>
                                    <Collapse in={!isOnlineCoinCollapsed} hidden={isOnlineCoinCollapsed}>
                                        <TableCell
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.coinDetail.onlineCoinAmount)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            align="center"
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.coinDetail.onlineCoinQuantity)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            align="center"
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.coinDetail.onlineFreeAmount)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            align="center"
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.coinDetail.onlineFreeQuantity)}
                                            </Typography>
                                        </TableCell>
                                    </Collapse>
                                </Box>
                                ...
                                <TableCell align="center"
                                    ...
                                    <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                        {currencyFormatter(item.node.coinAmountTotal)}
                                    </Typography>
                                </TableCell>
                                ...
                                <Box sx={{ backgroundColor: "transparent", alignItems: "center", display: "flex" }}>
                                    <TableCell
                                        ...
                                        <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                            {numberFormatter(item.node.giftDetail.immediateQuantity + item.node.giftDetail.offlineQuantity + item.node.giftDetail.combineQuantity)}
                                        </Typography>
                                    </TableCell>
                                    <Collapse in={!isGiftCollapsed} hidden={isGiftCollapsed} >
                                        <TableCell
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.giftDetail.immediateAmount)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            align="center"
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.giftDetail.immediateQuantity)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            align="center"
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.giftDetail.offlineAmount)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            align="center"
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.giftDetail.offlineQuantity)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            align="center"
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.giftDetail.combineAmount)}
                                            </Typography>
                                        </TableCell>
                                        <TableCell
                                            align="center"
                                            ...
                                            <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                                {numberFormatter(item.node.giftDetail.combineQuantity)}
                                            </Typography>
                                        </TableCell>
                                    </Collapse>
                                </Box>
                                ...
                                <TableCell align="center"
                                    ...
                                    <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                        {currencyFormatter(item.node.giftAmountTotal)}
                                    </Typography>
                                </TableCell>
                                <TableCell align="center"
                                    sx={{
                                    ...
                                    <Typography variant="h6" color={colors.primary[100]} sx={{}} >
                                        {currencyFormatter(item.node.earning)}
                                    </Typography>
                                </TableCell>
                                <TableCell align="center"
                                    sx={{
                ...
                <Box
                    ...
                    <LoadMore
                        ...
                        TYPE={"GET_MACHINE_STATISTIC_LIST"}
                        ARGS_ID={MACHINE_ID}
