                        ...
                        <ul className={boxClass.join(' ')}>
                            ...
                            <li onClick={toggleSubmenu1} className="menu-item sub__menus__arrows" > <Link to="#">{t('business')}<FiChevronDown /> </Link>
                                <ul className={boxClassSubMenu1.join(' ')} >
                                    <li><NavLink onClick={toggleClass} to={`/line`}>{t('line')}</NavLink> </li>
                                    <li><NavLink onClick={toggleClass} to={`/search-system`}>{t('search_system')}</NavLink> </li>
                                </ul>
                            </li>
                            ...
                            <li onClick={toggleSubmenu2} className="menu-item sub__menus__arrows" > <Link to="#">{t('service')}<FiChevronDown /> </Link>
                                <ul className={boxClassSubMenu2.join(' ')} >
                                    <li><NavLink onClick={toggleClass} to={`/marketing-system`}>{t('marketing_system')}</NavLink> </li>
                                    <li><NavLink onClick={toggleClass} to={`/xiaodi`}>{t('xiaodi')}</NavLink> </li>
                            ...
                            <li onClick={toggleSubmenu3} className="menu-item sub__menus__arrows" > <Link to="#">{t('entertainment')}<FiChevronDown /> </Link>
                                <ul className={boxClassSubMenu3.join(' ')} >
                                    <li> <NavLink onClick={toggleClass} to={`/ipickpro`}>iPickPro</NavLink> </li>
                                    <li><NavLink onClick={toggleClass} to={`/galaxy-city`}>{t('app_dev')}</NavLink> </li>
                                </ul>
                            </li>

                            {/* 多媒體設計 MENU ITEM */}
                            <li className="menu-item" ><NavLink onClick={toggleClass} to={`/media-design`}>{t('design')}</NavLink> </li>

                            {/* 多媒體設計 MENU ITEM */}
                            <li className="menu-item" ><NavLink onClick={toggleClass} to={`/About`}>{t('about')}</NavLink> </li>
                            ...
                            {/* <li onClick={toggleSubmenu4} className="menu-item sub__menus__arrows" > <Link to="#"><TbWorld /><br /><FiChevronDown /> </Link>
                                <ul className={boxClassSubMenu4.join(' ')} >
                                    <li><Link onClick={() => i18next.changeLanguage('en')}>EN</Link> </li>
                                    <li><Link onClick={() => i18next.changeLanguage('tw')}>中文</Link> </li>
                                </ul>
                            </li> */}
                        </ul>
