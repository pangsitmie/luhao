                ...
                <div className='galaxy_col2'>
                    <div className='galaxy_experience'>
                        ...
                        <div className='galaxy_exp_btn_container'>
                            <button className={`btn btn-stroke btn_galaxy_stroke intersection_hidden ${elementIsVisible ? 'intersection_show' : ''}`} ref={visibleRef}>
                                <a href="#0">
                    ...
                    <div className='galaxy_contact'>
                        ...
                        <div className='galaxy_contact_btn_container'>
                            <button className={`btn btn-stroke intersection_hidden ${elementIsVisible2 ? 'intersection_show' : ''}`} ref={visibleRef2}>
