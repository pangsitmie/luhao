        ...
        <div className='relative bg-black px-[8%] text-white pb-20'>
            ...
            <div className='search_revenue'>
                ...
                <div className='search_revenue_desc'>
                    <div className={`intersection_hidden ${inView2 ? 'intersection_show' : ' '}`} ref={ref2}>
            ...
            <div className='search_language'>
                ...
                <div className='search_language_img'>
                    <img className={`intersection_hidden ${inView3 ? 'intersection_show' : ' '}`} ref={ref3} src={MULTIPLE_LANGUAGE} alt="" />
                </div>
            </div>
