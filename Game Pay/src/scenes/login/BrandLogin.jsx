    ...
    return (
        <Box className='login_page' backgroundColor={colors.primary[400]} >
            <div className="container">
                <div className="box">
                    <span className="title">GAME PAY BRAND</span>
                    <button onClick={() => dispatch(setCompany())}>Set Company</button>
                    ...
                    <Box display={"flex"} justifyContent={"space-between"} p={"2rem 0 0 0"}>
                        <span>
                            <button className='btn_right_arrow' onClick={() => dispatch(setBrand())}>
                                品牌登入
                                <div className="arrow-wrapper">
                                    <div className="arrow"></div>
                                </div>
                        ...
                        <span>
                            <button className='btn_right_arrow' onClick={() => dispatch(setStore())}>
                                店家登入
                                <div className="arrow-wrapper">
                                    <div className="arrow"></div>
                                </div>
