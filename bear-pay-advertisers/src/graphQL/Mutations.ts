...
mutation CreateBrand(
  $name: String!
  $principal: CreateBrandPrincipalArgs!
  $intro: String
  $currencyName: String
  $cover: String
  $logo: String
...
`
export const CreateAdvertisersForManager = gql`
mutation CreateAdvertisersForManager(
  $account: String!
  $name: String!
  $password: String!
  $principalName: String!
  $principalPhone: PhoneInput!
) {
  createAdvertisersForManager(
    account: $account
    name: $name
    password: $password
...
export const PatchAdvertisersForManager = gql`
mutation PatchAdvertisersForManager(
  $advertisersId: ID!
  $name: String
  $principalName: String
  $principalPhone: PhoneInput
) {
  patchAdvertisersForManager(
...
export const RemoveAdvertisersForManager = gql`
mutation RemoveAdvertisersForManager($advertisersId: ID!) {
  removeAdvertisersForManager(advertisersId: $advertisersId)
}
`

export const ManagerCreateStoreEmployee = gql`
mutation ManagerCreateStoreEmployee(
  $account: String!
  $password: String!
  $name: String!
  $storeId: ID!
) {
  managerCreateStoreEmployee(
    account: $account
    password: $password
    name: $name
    storeId: $storeId
