...
import CreateStoreEmployeeModal from './CreateStoreEmployeeModal';
    ...
    return (
        <Box p={2} display="flex" flexDirection={"column"}>
            ...
            <Box display={"flex"} marginBottom={"2rem"} alignItems={"center"} gap={"1rem"}>
                ...
                >
                    {entityName === 'company' ? <CreateStoreModal onUpdate={() => triggerRefetch()} /> :
                        entityName === 'brand' ? <CreateStoreModal_B onUpdate={() => triggerRefetch()} /> : null
                    }
            ...
            >
                ...
                >
                    ...
                    {entityName === 'store' && (
                        <Box width={"15%"} display="flex" alignItems={"center"} justifyContent={"center"}>
                            <Typography color={colors.grey[100]} variant="h5" fontWeight="500">{t('create_employee')}</Typography>
                        </Box>
                    )}
                            ...
                            >
                                ...
                                {entityName === 'store' && (
                                    <Box
                                        ...
                                        alignItems={"center"} justifyContent={"center"}
                                        borderRadius="4px">
                                        <CreateStoreEmployeeModal storeId={store.node.id} onUpdate={() => triggerRefetch()} />
                                    </Box>
                                )}
                                <Box
                                    width={"15%"}
