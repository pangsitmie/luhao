...
import MachineStatisticCommodityHistories from './MachineStatisticCommodityList';
            ...
            >
                ...
                >
                    ...
                    <Box sx={{
                        ...
                        alignItems: "center",
                        justifyContent: "center",
                        minWidth: commodityRecordsCollapsed ? "150px" : "fit-content",
                        backgroundColor: colors.primary[400]
                    }}>
                        <Typography variant="h5" color={colors.primary[100]} sx={{ fontSize: "1rem", fontWeight: "500" }} >
                            {t('total_expense')}
                            ...
                            machineDatas.map((item, index) => {
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align="center"
                                            sx={{
                                                minWidth: commodityRecordsCollapsed === index ? "750px" : "150px",
                                                padding: ".25rem 1.5rem",
                                                display: "flex",
                                                flexDirection: "column",
                                                justifyContent: "center",
                                            ...
                                            <Box display={"flex"} alignItems={"center"} justifyContent={"center"} gap={"5px"}>
                                                ...
                                                {item.commodityHistories.length > 0 && (
                                                    <Button onClick={() => handleCommodityRecordsToggle(index)} sx={{ padding: "2px", minWidth: "14px" }}>
                                                        {commodityRecordsCollapsed === index ? (
                                                            <ArrowDropUpIcon sx={{ color: colors.greenAccent[500], fontSize: "14px" }} />
                                                        ) : (
                                                            <ArrowDropDownIcon sx={{ color: colors.greenAccent[500], fontSize: "14px" }} />
                                                        )}
                                                    </Button>
                                                )}
                                            </Box>
                                            {item.commodityHistories.length > 0 && (
                                                <MachineStatisticCommodityHistories commodityHistories={item.commodityHistories} collapsed={commodityRecordsCollapsed !== index} />
                                            )}
                                        </TableCell>
