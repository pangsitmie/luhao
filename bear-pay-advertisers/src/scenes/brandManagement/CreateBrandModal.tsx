...
const checkoutSchema = yup.object().shape({
  ...
  principalPassword: yup.string().required("required").matches(passwordRegex, "must contain at least one letter and one number, and be at least six characters long"),
  ...
  const handleFormSubmit = (values: FormValues) => {
    ...
    const variables: any = {
      ...
      principal: {
        ...
        lineUrl: values.principalLineUrl !== "" ? values.principalLineUrl : undefined,
        phone: {
          country: "tw",
