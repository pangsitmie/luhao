        ...
        <Opening
          ...
          left={
            <div className={styles["lefttext"]}>
              <h1>El servicio de WINPRO de atraer a los fans.</h1>
              <p>Según la necesidad del cliente ofrecemos el servicio de la promoción de la publicidad a medida del cliente.</p>
              <div>
