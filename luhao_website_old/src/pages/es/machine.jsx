...
export default class machine extends Component {
    ...
    Type: [
      {
        id: 1,
        type_name: "選物販賣機",
        subtitle: "Máquina expendedora con diferentes opciones",
      },
      { id: 2, type_name: "兌幣機", subtitle: "Cambio de moneda Máquina" },
      { id: 3, type_name: "禮品機", subtitle: "Maquina de regalos" },
      {
        id: 4,
        type_name: "打擊&騎乘類",
        subtitle: "Máquina de golpear y montar",
      },
      { id: 5, type_name: "進口機台", subtitle: "Maquina importada" },
    ],
    machinedata: null,
  }
  ...
  componentDidMount() {
    var machineData = machineListApi("es")
    machineData
      .then(res => {
        return res.data
      })
