        ...
        <Opening
          ...
          left={
            <div className={styles["lefttext"]}>
              ...
              <p>Lista multimedia de los productos de la nube WINPRO.</p>
              <div>
  ...
  return(
    <div>
      <div>
        <div>
          <div>
            <h1>Tiroteo publicitario</h1>
            <p>Videos Comerciales</p>
          </div>
        </div>
        <div>
          <div>
            <h1>filmación de video publicitaria</h1>
    ...
    <div>
      <div>
        ...
        <div className={styles["imgBox"]} onClick={this.headleChange.bind(this,4)}>
          ...
          <div>
            <h2>Redondo</h2>
            <p>Una nube suave, lo más intrigante es que su cuerpo redondo, sus amigos también están en la nube de la serie, hay muchos hermanos y hermanas en la familia, es la hija mayor de la familia.
              <br/>
              <span>——李瑜庭/楊芸茹</span>
            </p>
          </div>
      ...
      <div>
        <div className={styles["imgBox"]} onClick={this.headleChange.bind(this,5)}>
          ...
          <div>
            <h2>PAPAC</h2>
              <p>PAPAC pensó que era feroz, pero en realidad era un chico natural y encantador a los ojos de los demás. La capa de Papak originalmente tenía la intención de cubrir su desconfianza hacia el cuerpo del dinosaurio, pero encontró...
                <br/>
              <span>Author</span>
            </p>
          </div>
    ...
    case 4:
      return(
        <div>
          ...
          <div className='stickersshowRight'>
            <h1>Redondo</h1>
            <p>Una nube suave, lo más intrigante es que su cuerpo redondo, sus amigos también están en la nube de la serie, hay muchos hermanos y hermanas en la familia, es la hija mayor de la familia.</p>
            <p>——李瑜庭/楊芸茹</p>
          </div>
        </div>
      )
      ...
      return(
        <div>
          ...
          <div className='stickersshowRight'>
            <h1>PAPAC</h1>
            <p>
              PAPAC pensó que era feroz, pero en realidad era un chico natural y encantador a los ojos de los demás. La capa de Papak originalmente tenía la intención de cubrir su desconfianza hacia el cuerpo del dinosaurio, pero encontró...
            </p>
            <p>Author</p>
          </div>
        </div>
